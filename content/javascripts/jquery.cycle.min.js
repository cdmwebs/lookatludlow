;(function($){var ver='2.89';if($.support==undefined){$.support={opacity:!($.browser.msie)};}
...
go(options.elements,options,1,(!options.rev&&!options.backwards));}}};function removeFilter(el,opts){if(!$.support.opacity&&opts.cleartype&&el.style.filter){try{el.style.removeAttribute('filter');}
